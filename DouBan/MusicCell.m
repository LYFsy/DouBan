...
- (void)addTimeLabel {
    if (!_timeLabel) {
        ...
        _timeLabel.text = [NSString stringWithFormat:@"时间:%@",self.musicM.pubdate];
    }
}
...
- (void)addAuthorLabel {
    if (!_authorLabel) {
        ...
        _authorLabel.text = [NSString stringWithFormat:@"演唱:%@",self.musicM.authorStr];
    }
}
...
- (void)addAverageLabel {
    if (!_averageLabel) {
        ...
        _averageLabel.text = [NSString stringWithFormat:@"评分:%@",self.musicM.average];
    }
}
